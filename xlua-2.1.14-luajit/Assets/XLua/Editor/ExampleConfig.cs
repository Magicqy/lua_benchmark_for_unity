...
public static class ExampleConfig
{
    ...
    static List<string> exclude = new List<string> {
        ...
        //2.1.14release版本在Unity2018.4.2f1版本安卓平台无法正常打包，需要添加以下排除类型才可以解决
        "Texture", "Light", "LightProbe", "DrivenRectTransformTracker", "QualitySettings", "ParticleSystem",
        "Input", "Caching", "AudioSettings", "AnimatorControllerParameter", "CanvasRenderer"
    };
