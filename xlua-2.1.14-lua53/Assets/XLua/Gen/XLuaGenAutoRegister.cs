...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit5(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(benchmark), benchmarkWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate void __GEN_DELEGATE12( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles,  int offset,  int count);
		
		delegate void __GEN_DELEGATE13( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles);
		
		delegate int __GEN_DELEGATE14( UnityEngine.ParticleSystem ps,  UnityEngine.GameObject go,  UnityEngine.ParticleCollisionEvent[] collisionEvents);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.ParticleSystem), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE12(UnityEngine.ParticlePhysicsExtensions.SetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE14(UnityEngine.ParticlePhysicsExtensions.GetCollisionEvents)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
