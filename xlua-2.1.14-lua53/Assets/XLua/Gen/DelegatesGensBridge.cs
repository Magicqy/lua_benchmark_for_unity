...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp3(string p0, bool p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.AudioClip.PCMReaderCallback(__Gen_Delegate_Imp1);
			}
			...
			{
			    return new UnityEngine.Application.AdvertisingIdentifierCallback(__Gen_Delegate_Imp3);
			}
